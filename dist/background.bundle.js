...
var getNotificationId = function getNotificationId() {
  var id = Math.floor(Math.random() * 9007199254740992) + 1;
  return id.toString();
};

var showNotification = function showNotification(selectionText) {
  chrome.notifications.create(getNotificationId(), {
    type: 'basic',
    title: 'Success!',
    iconUrl: 'img/icon.png',
    message: '\'' + selectionText + '\' posted successfully to CodeCode Ninja' }, function () {
